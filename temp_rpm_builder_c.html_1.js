        ...
        function navigateTo(page) {
            if (page === 'create') {
                ...
                currentModuleData = { judul_modul: 'MODUL AJAR', penyusun: _guru, sekolah: _sek, kepala_sekolah_nama: _kep, kepala_sekolah_nip: _nipK, penyusun_nip: _nipG, tahun_ajar: '2024/2025', fase_kelas: 'Fase C / Kelas 5', semester: '1 (Ganjil)', mapel: '', elemen: '', materi: '', alokasi_waktu: '2 x 35 Menit (1 kali pertemuan)', cp: '', tp: '', pendekatan: '', model: '', metode: [], profil_lulusan: [], mitra_internal: [], mitra_eksternal: [], lingkungan_fisik: [], budaya_belajar: [], media_non_digital: [], platform_aplikasi: [], perangkat_digital: [], media_digital: [], selected_materi: [], selected_karakteristik: [], validasi_langkah: '', validasi_asesmen: '', validasi_lkpd: '', validasi_rubrik: '', validasi_evaluasi: '', relevansi_materi: '', custom_data: { karakteristik: [], metode: [], mitra_internal: [], mitra_eksternal: [], lingkungan_fisik: [], budaya_belajar: [], media_non_digital: [], platform_aplikasi: [], perangkat_digital: [], media_digital: [], selected_materi_manual: [] }, history: {}, history_idx: {} };
        ...
        <div class="w-full h-full gradient-bg-primary overflow-auto flex items-center justify-center p-4 builder-ui">
            <div class="max-w-4xl w-full bg-black rounded-[3rem] shadow-2xl overflow-hidden border-4 border-yellow-500 flex flex-col animate-fade-in">
                ...
                <div class="p-8 md:p-12 text-center bg-transparent flex-1 font-black italic">
                    ...
                    <p class="text-blue-400 font-bold mb-10 tracking-widest uppercase text-sm font-black">Edisi Fase C (Kelas 5 & 6) BSKAP 046</p>
...
3. Asesmen Sumatif
   ...
   (b). Cara/Sumber: [WAJIB disesuaikan dengan hasil nyata aktivitas peserta didik]
        ...
        <div class="bg-blue-950/20 p-5 rounded-3xl border-l-8 border-blue-900 animate-fade-in"><label class="block text-[10px] font-black text-blue-400 uppercase mb-1">🎯 Fase / Kelas</label><select id="fase_kelas" class="select-modern p-4 rounded-2xl font-bold"><option value="Fase C / Kelas 5" ${d.fase_kelas === 'Fase C / Kelas 5' ? 'selected' : ''}>Fase C / Kelas 5</option><option value="Fase C / Kelas 6" ${d.fase_kelas === 'Fase C / Kelas 6' ? 'selected' : ''}>Fase C / Kelas 6</option></select></div>
        ...
        function stepIdentifikasi() {
            ...
            <div class="bg-black p-8 border-2 rounded-[2.5rem] border-blue-900 shadow-sm">
                <h3 class="text-xl font-black text-center text-yellow-500 uppercase mb-8 italic">👦 Karakteristik Murid Fase C</h3>
        ...
        function stepReview() {
            ...
            <div class="blok-identifikasi" style="page-break-inside: avoid; break-inside: avoid; padding-top: 5mm;">
                ...
                <table class="doc-table" border="0">
                    ...
                    ${row('2. Karakteristik Murid', `Karakteristik murid Fase C secara umum memiliki karakter ${(d.selected_karakteristik || []).join(', ')} yang membutuhkan perhatian guru untuk memfasilitasi kebutuhan belajar mereka.`, true)}
